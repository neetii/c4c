  ...
  return (
    <footer style={{ background: '#CD3838', padding: '48px 40px' }}>
      <div style={{ maxWidth: '1512px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '32px', marginTop: '32px', alignItems: 'start' }}>
          ...
          <div style={{ marginTop: '-70px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0px', marginBottom: '16px', marginLeft: '-50px', marginTop: '25px' }}>
              <img src="/images/c4c_logo4.png" style={{ width: '120px', height: '120px', objectFit: 'contain' }} />
              <h3 style={{ fontSize: '40px', fontWeight: 400, color: '#F0DA9D', margin: 0, marginLeft: '-30px', fontFamily: 'Nunito, sans-serif' }}>Care4Caregivers</h3>
            </div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, marginTop: '-35px', fontSize: '24px', color: '#F0DA9D', opacity: 0.55, fontFamily: 'Nunito, sans-serif' }}>
